...
insert into belbin_roles (belbin_role_name, belbin_role_description, belbin_role_color) values ('Vyhledavač zdrojů', 'Je nadšený a komunikativní extrovert. Objevuje příležitosti. Rozvíjí kontakty. Jeho přípustnou slabinou je nadměrný optimismus. Může ztratit zájem po opadnutí počátečního nadšení.', '#FF7F50');
insert into belbin_roles (belbin_role_name, belbin_role_description, belbin_role_color) values ('Koordinátor', 'Je vyzrálý a sebejistý. Vyjasňuje cíle. Dává lidi dohromady, aby podpořil týmovou diskusi. Může se zdát, že manipuluje. Usnadňuje si osobní práci.', '#6495ED');
insert into belbin_roles (belbin_role_name, belbin_role_description, belbin_role_color) values ('Formovač', 'Je vyzrálý a sebejistý. Vyjasňuje cíle. Dává lidi dohromady, aby podpořil týmovou diskusi. Může se zdát, že manipuluje. Usnadňuje si osobní práci.', '#DC143C');
insert into belbin_roles (belbin_role_name, belbin_role_description, belbin_role_color) values ('Analytik', 'Je vážně založený, je stratég a má vysoké nároky. Vidí všechny možnosti. Má přesný úsudek. Může mu chybět hnací síla a schopnost inspirovat ostatní.', '#B8860B');
...
insert into belbin_roles (belbin_role_name, belbin_role_description, belbin_role_color) values ('Realizátor', 'Je disciplinovaný, spolehlivý, konzervativní v návycích. Má schopnost činit praktické kroky a akce. Může mu chybět flexibilita a nemusí si všímat nevyzkoušených myšlenek.', '#483D8B');
insert into belbin_roles (belbin_role_name, belbin_role_description, belbin_role_color) values ('Dotahovač', 'Dotahovači jsou známí vyzýváním k výkonu, dynamickým vystupováním i prožíváním, daří se jim pod tlakem. Jsou průbojní a mají odvahu překonávat překážky. Mohou mít sklony provokovat a druhé zraňovat.', '#228B22');
...
insert into belbin_roles (belbin_role_name, belbin_role_description, belbin_role_color) values ('Neutrální body', 'Toto není týmová role. V každé otázce je jedna odpověď, která není spojena s žádnou rolí. Body přidělené této odpovědi jsou pak započteny jako neutrální.', '#A9A9A9');
