<div class="container">
	<h1 class="display-4">Belbinův test týmových rolí</h1>
	<h2 class="display-5">(ONLINE)</h2>
...
<div class="container">	
			...
			<p>
				...
				<script>
					var data = {
						datasets: [{
							data: [10, 20, 30],
							backgroundColor: ['CadetBlue', 'Coral', 'CornflowerBlue', 'Crimson', 'DarkGoldenRod', 'DarkOliveGreen', 'DarkSlateBlue', 'ForestGreen', 'IndianRed' ]
						}],
	...
	<div class="row">
		<div class="col-md-6">
			...
			<p><a class="btn btn-primary" href="role" role="button">Seznam rolí &raquo;</a></p>
		</div>
		<div class="col-md-6">
			<h2>O testu</h2>
